    ...
    <main>
      ...
      >
        ...
        >
          ...
          vos priorités tout au long du projet. Du premier atelier à la mise en
          production, chaque étape est maîtrisée
        </motion.p>
        <motion.p
          variants={{
            hidden: { opacity: 0, y: 40 },
        ...
        >
          ...
          créer un outil <span className="font-semibold">réellement utile</span>{" "}
          et <span className="font-semibold">adapté</span> à votre
          fonctionnement.
        </motion.p>
        <motion.p
          variants={{
          ...
          className="text-center text-xl leading-loose lg:text-left 2xl:text-2xl"
        >
          Je suis profondément convaincu que la réussite d&apos;un projet repose
          avant tout sur une{" "}
          <span className="font-semibold">bonne communication</span>, c&apos;est
          pourquoi je favorise les échanges{" "}
